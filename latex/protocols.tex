...
Whether a node or a gateway actually implement these error messages is up to the user. Current \mbox{\hyperlink{classPowerNode}{Power\+Node}} implementation only prints node error messages. \hypertarget{data_protocol}{}\doxysection{Data transfer protocol}\label{data_protocol}
