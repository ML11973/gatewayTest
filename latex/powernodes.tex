\hypertarget{powernodes_autotoc_md23}{}\doxysubsection{Description}\label{powernodes_autotoc_md23}
...
\end{DoxyItemize}\hypertarget{powernodes_autotoc_md24}{}\doxysubsection{Usage}\label{powernodes_autotoc_md24}
\hypertarget{powernodes_autotoc_md25}{}\doxysubsubsection{Instantiation}\label{powernodes_autotoc_md25}
Instantiate using any constructor. Constructors match \mbox{\hyperlink{classNode}{Node}} type constructor. A constructor for \mbox{\hyperlink{classPowerNode}{Power\+Node}} instantiation from a \mbox{\hyperlink{classNode}{Node}} object exists.\hypertarget{powernodes_autotoc_md26}{}\doxysubsubsection{Sending commands}\label{powernodes_autotoc_md26}
Use any function starting with app\+\_\+ to issue an \mbox{\hyperlink{app_protocol}{Application protocol}} command.

Other operations are inherited from parent \mbox{\hyperlink{classNode}{Node}}.\hypertarget{powernodes_autotoc_md27}{}\doxysubsubsection{Debugging}\label{powernodes_autotoc_md27}
\mbox{\hyperlink{wpan_8h}{wpan.\+h}} provides two DEBUG macros for this class. Uncomment \#\+DEBUG\+\_\+\+RXTX to show all incoming and outgoing frames. Uncomment \#\+DEBUG\+\_\+\+APP to show only \mbox{\hyperlink{app_protocol}{Application protocol}} frames.\hypertarget{powernodes_autotoc_md28}{}\doxysubsection{Implementation details}\label{powernodes_autotoc_md28}
\hypertarget{powernodes_autotoc_md29}{}\doxysubsubsection{Frame IO}\label{powernodes_autotoc_md29}
This class does not provide a method to directly transmit data to its remote node. Instead, it provides wrappers like its parent class.\hypertarget{powernodes_autotoc_md30}{}\doxysubsubsection{Command functions}\label{powernodes_autotoc_md30}
...
In case of low household power production, C would be shut down first, then B.\hypertarget{powernodes_autotoc_md35}{}\doxysubsubsection{Power}\label{powernodes_autotoc_md35}
...
In any case, measured power must be true and should be used for computations.\hypertarget{powernodes_autotoc_md36}{}\doxysubsubsection{Power settings}\label{powernodes_autotoc_md36}
...
Settings are chosen by sending their index with \mbox{\hyperlink{classPowerNode_aa3fe7956f1542a389384284b6490cff6}{Power\+Node\+::app\+\_\+set\+Power\+Setting}}.\hypertarget{powernodes_autotoc_md37}{}\doxysubsubsection{Description}\label{powernodes_autotoc_md37}
This is a simple description sent by the remote node. It is somewhat comparable to a hostname in local networks. Its maximum size is limited by the PHY max size. It is defined in \mbox{\hyperlink{wpan_8h_a9d57da126c1cf06709df7a483256a95f}{APP\+\_\+\+MAX\+\_\+\+DESC\+\_\+\+LENGTH}}. \hypertarget{app_protocol}{}\doxysection{Application protocol}\label{app_protocol}
...
\end{DoxyItemize}\hypertarget{nodes}{}\doxysection{Nodes}\label{nodes}
\hypertarget{nodes_autotoc_md12}{}\doxysubsubsection{Description}\label{nodes_autotoc_md12}
...
Protocol commands can be blocking or non-\/blocking depending on argument timeout value. If timeout is 0, command is non-\/blocking. Status can be manually checked using a \mbox{\hyperlink{classNode_a8ba73358ec29eca790ba4f084c8059f7}{Node\+::ping\+Status}}-\/style function.\hypertarget{nodes_autotoc_md16}{}\doxyparagraph{Debugging}\label{nodes_autotoc_md16}
\mbox{\hyperlink{wpan_8h}{wpan.\+h}} provides two DEBUG macros for this class. Uncomment \#\+DEBUG\+\_\+\+RXTX to show all incoming and outgoing frames. Uncomment \#\+DEBUG\+\_\+\+NET to show only \mbox{\hyperlink{net_protocol}{Network protocol}} frames.\hypertarget{nodes_autotoc_md17}{}\doxysubsubsection{Implementation details}\label{nodes_autotoc_md17}
\hypertarget{nodes_autotoc_md18}{}\doxyparagraph{Frame IO}\label{nodes_autotoc_md18}
...
\hypertarget{nodes_autotoc_md19}{}\doxyparagraph{Command functions}\label{nodes_autotoc_md19}
