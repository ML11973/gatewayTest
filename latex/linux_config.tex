The CM4 microcomputer uses a custom distribution using Buildroot. It uses the Pi CM4\textquotesingle{}s default bootloader. See platform\+\_\+config for more information about Buildroot.\hypertarget{linux_config_autotoc_md1}{}\doxysubsubsection{SSH configuration}\label{linux_config_autotoc_md1}
...
\end{DoxyCode}
\hypertarget{linux_config_autotoc_md2}{}\doxysubsubsection{Ulimit}\label{linux_config_autotoc_md2}
...
\end{DoxyCode}
 to grant more open file descriptors to the program and avoid this problem.\hypertarget{linux_config_autotoc_md3}{}\doxysubsubsection{Automatically starting the application}\label{linux_config_autotoc_md3}
...
Busy\+Box will execute all properly-\/named service scripts on startup.\hypertarget{linux_config_autotoc_md4}{}\doxysubsubsection{Automatically restarting the application after a crash}\label{linux_config_autotoc_md4}
